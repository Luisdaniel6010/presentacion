...
function Home() {
    ...
    return (
        ...
        <header>
            ...
            <a href="./components/catalogo/index.js"><button class="boton"><span>Catalogo</span></button></a>
     ...
     <footer class="pie">
        <div>
            <h2>Programas de Apoio</h2><br></br>
                <img src={require('./components/imagenes/logo1.jpg' )}alt="logo1" className='logos'/>
                <img src={require('./components/imagenes/logo2.jpg' )}alt="logo2" className='logos'/>
                <img src={require('./components/imagenes/logo1.jpg' )}alt="logo1" className='logos'/>
                <img src={require('./components/imagenes/logo2.jpg' )}alt="logo2" className='logos'/>
        </div>
